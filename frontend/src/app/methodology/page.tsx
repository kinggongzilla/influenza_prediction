...
const models = [
  ...
  { name: "ISI-FluABCaster", rwis: 0.91, note: "", rank: 4 },
  { name: "Influcast quantile baseline", rwis: 1.0, note: "baseline", rank: 5 },
  { name: "C2S2_Trento-SIR_INN", rwis: 1.0, note: "", rank: 6 },
  { name: "Chronos-2 zero-shot (unfine-tuned)", rwis: 1.01, note: "", rank: 7 },
